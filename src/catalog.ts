...
const advancedFinance: Record<string, Partial<Tool>> = {
  'simple-interest-calculator': { op:'simpleInterestAdvanced', advanced:true, description:'Calculate simple interest, total amount, and interest earned or owed from principal, annual rate, and time in years, months, or days.', inputs:[{key:'v0',label:'Principal',value:5000,type:'number',min:0,help:'Starting amount borrowed or invested.'},{key:'v1',label:'Annual interest rate (%)',value:5,type:'number',min:0,max:1000,step:.01,help:'Annual simple-interest rate.'},{key:'v2',label:'Time',value:3,type:'number',min:0,step:.01,help:'Length of the interest period; choose years, months, or days above.'}], formula:'Interest = principal × (annual rate ÷ 100) × time in years; total = principal + interest', unit:'total amount', params:[], keywords:['simple interest calculator','simple interest formula','simple interest with months','simple interest with days','principal and interest calculator'] },
...
const highIntentCopy: Record<string, string> = {
  ...
  'simple-interest-calculator': 'Calculate simple interest, total amount, and interest earned or owed from principal, annual rate, and time in years, months, or days.',
